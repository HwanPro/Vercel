      ...
      <header className="px-4 lg:px-6 h-14 flex items-center bg-black">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          {status === "loading" ? (
            ...
            // Si el usuario está autenticado, muestra un botón según el rol
            ...
            // Si el usuario no está autenticado, muestra "Inicia sesión"
            <Button
              onClick={handleLogin}
        ...
        >
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="bg-white text-black flex flex-col items-center p-6 rounded-lg shadow-md">
                <CardHeader className="text-center">
                  <CardTitle className="text-yellow-400 text-2xl mb-2">
                    Plan Mensual
                  </CardTitle>
                  <CardDescription className="text-gray-600 mb-4">
                    Ideal para probar nuestros servicios
                  </CardDescription>
                </CardHeader>
              ...
              {/* Repite el mismo patrón para los otros planes */}
